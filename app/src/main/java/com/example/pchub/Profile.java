...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = (Button) findViewById(R.id.logoutbtn);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View view1 = LayoutInflater.from(Profile.this).inflate(R.layout.update_profile,null);
                ...
                textView2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(Profile.this, "You Can't update your Email", Toast.LENGTH_SHORT).show();
                ...
                textViewp.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(Profile.this, "You Can't update your Password", Toast.LENGTH_SHORT).show();
                    }
                });
